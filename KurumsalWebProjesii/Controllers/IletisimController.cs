...
namespace KurumsalWebProjesii.Controllers
{
    public class IletisimController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Iletisimıd,Adres,Telefon,Fax,Whatsapp,Facebook,Twitter,Instagram")] Iletisim iletisim)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Iletisimıd,Adres,Telefon,Fax,Whatsapp,Facebook,Twitter,Instagram")] Iletisim iletisim)
        {
            if (ModelState.IsValid)
            {
